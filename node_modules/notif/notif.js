...
class Notif {
  ...
  /**
   * Prompt a new notificatoon.
   * @param {string} title The header title of the notification.
   * @param {string} message Optional longer message or content.
   * @param {number} dieAfter If set, automatically close the notification after ``dieAfter`` milliseconds.
   */
  constructor(title, message, dieAfter)
  {
    ...
    /**
     * Back reference to the instance of the notification.
     */
    ...
    /**
     * Reference to the notification element in HTML.
     */
    this.object = mainDiv;
    /**
     * Reference to the notification's title text.
     */
    this.titleObject = h1;
    /**
     * Reference to the notification's description text.
     */
    this.descriptionObject = p;
    /**
     * Reference to the notification's button object.
     */
  ...
  /**
   * Adding Notification Styling to the document. If not used before using a notification object, it creates a default styling.
   * @param {{}} options 
   */
  ...
  /**
   * Make the notification uninteractable.
   */
  makeUntouchable()
  {
  ...
  /**
   * Close the newest/top notification.
   */
  static closeNewest()
  {
  ...
  /**
   * Specify notification by id to close.
   * @param {number} id id to close.
   */
  static closeById(id)
  {
    if (!id) {
  ...
  /**
   * Close a notification by its HTML object reference.
